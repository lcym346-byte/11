...
export default function Layout() {
  ...
  const navItems = [
    ...
    { path: '/suppliers', icon: Truck, label: t('nav.suppliers'), adminOnly: true },
    { path: '/inventory', icon: Boxes, label: t('nav.inventory') },
    { path: '/reports', icon: BarChart3, label: t('nav.reports') },
    { path: '/notifications', icon: Bell, label: t('nav.notifications') },
    { path: '/users', icon: Users, label: t('nav.users'), adminOnly: true },
